...
class VITS_PinYin:
    ...
    def chinese_to_phonemes(self, text):
        ...
        return " ".join(phonemes), char_embeds, chars, count_phone

    def correct_pinyin_tone3(self, text):
        pinyin_list = lazy_pinyin(text, style=Style.TONE3, strict=False, neutral_tone_with_five=True, tone_sandhi=True)
